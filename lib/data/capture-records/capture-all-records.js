 ...
 */
export function captureAllRecords(repo, cid, rec, store, asOf, intercepts) {
  switch (rec['$type']) {
    ...
    case 'app.bsky.feed.post':
      return capturePostRecord(repo, cid, /** @type {RepoRecord$Typed['app.bsky.feed.post']} */(rec), store, asOf, intercepts);
